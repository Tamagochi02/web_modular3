...
export const privateRoute = (handler, ignoreMethods = "") => { // ignoreMethods para ejecutar un metodo sin autorizacion
  return withIronSessionApiRoute((req, res) => {
    if (ignoreMethods.includes(req.method)) { // valida si el metodo ignorado es una peticion y retorna un handler
